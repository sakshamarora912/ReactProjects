...
export default function AuthInputs() {
  ...
  function handleLogin() {setSubmitted(true);}
    ...
    <div id="auth-inputs">
      <ControlContainer className="controls">
        <p className='paragragh'>
          ...
          <Input 
            type="email" className={`input ${emailNotValid ? 'invalid' : undefined}`}
        ...
        <p>
          ...
          <Input
            type="password"className={`input ${passwordNotValid ? 'invalid' : undefined}`}
